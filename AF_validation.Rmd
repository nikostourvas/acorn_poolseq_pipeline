...
#Create the 2D histogram plot:
  ...
  px <- ggplot(dataset, aes(x=alt_ind)) + geom_histogram(bins=bins) + theme_void()
  py <- ggplot(dataset, aes(x=alt_pool)) + geom_histogram(bins=bins) + theme_void() +
                coord_flip()
...
rawdiffplot <- function(dataset, bins=37){
  ...
  py <- ggplot(dataset, aes(x=alt_ind)) + geom_histogram(bins=bins) + theme_void() +
                coord_flip()
