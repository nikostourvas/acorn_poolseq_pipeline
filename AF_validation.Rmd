...
```{r}
# Pool data
poplist <- getpooldata("/data/genetics_tmp/mapping_tests/results_NT/duplicate_filtering_AF_validation/VCF_dedup/validationIndelFilteredSNPs_Biallelic_500kb_ADP100_bcftoolsDP30_AlleleFrequencyTable.txt", "305_dedup", "312_dedup")
poplist_dedup <- poplist
```
...
```{bash, eval=FALSE}
bcftools stats --threads 10 --fasta-ref /data/genetics_tmp/TEST_LL/REFERENCE/Qrob_PM1N_Organelles.fa \
    /data/genetics_tmp/mapping_tests/results_NT/duplicate_filtering_AF_validation/VCF_dedup/validationIndelFilteredSNPs_Biallelic_500kb_ADP100_bcftoolsDP30.vcf.gz \
    > /data/genetics_tmp/mapping_tests/results_NT/duplicate_filtering_AF_validation/VCF_dedup/validationIndelFilteredSNPs_Biallelic_500kb_ADP100_bcftoolsDP30.vcf_stats.txt
```
