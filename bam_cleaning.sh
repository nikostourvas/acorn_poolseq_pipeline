...
# Quality filter 
samtools view -@ 15 -bh -q 20 ${OUTPUT}.fixmate.newsort.bam > ${OUTPUT}.sort.Q20.bam
...
samtools markdup -@ 15 ${OUTPUT}.sort.Q20.bam ${OUTPUT}.sort.Q20.markdup.bam
# index
samtools index -@ 15 ${OUTPUT}.sort.Q20.markdup.bam
# gather stats
