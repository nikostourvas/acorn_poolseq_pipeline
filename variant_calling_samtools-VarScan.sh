...
/programs/samtools/bin/samtools mpileup -B -q 1 -f $REF $DATA/*_sort.bam > $RESULTS/cohort.mpileup
java -jar /home/nikos/NGS/VarScan.jar mpileup2snp $RESULTS/cohort.mpileup \
