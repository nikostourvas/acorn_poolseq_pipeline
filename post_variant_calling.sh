...
#The script devides tasks up along three sub-scripts. No user input is needed as soon as this script is initiated. 
...
# Merge the multiple small VCF files that were produced in the previous step into one large VCF.
