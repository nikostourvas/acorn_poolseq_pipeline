...
parallel --verbose -j 50 'Rscript /home/geneticsShare/acorn_poolseq_pipeline/LFMM_DeterminingK_Part1.R {}' :::: ./par/LFMM_DeterminingK_Parameters_Part1_${POPULATIONS}.txt
