...
UNTRIMMED=/mnt/AcornSeqdata/TestDirectoryTrimmomatic #A directory that contains the untrimmed files that you'd like to process.
TRIMMED=../results/trimmed_fastq #The output directory for trimmed reads.
ADAPTER=/mnt/data/adapters/TruSeq3-PE-2.fa #Location of a file that contains information about the adapters that were used to sequence the reads.
