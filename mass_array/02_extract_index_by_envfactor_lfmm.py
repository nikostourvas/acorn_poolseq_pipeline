#!/usr/bin/env python3
"""
Script to extract index column values for each envfactor from LFMM CSV file
...
def extract_index_by_envfactor_lfmm():
    # Input CSV file path
    csv_file = "/home/geneticsShare/LFMM_ANALYSES/res_robust/WZA_res/ACORN_Qpet_1CA_MinDP20_MaxMeanDP178_Miss0075_MAF005_HDplot_significant_windows_LFMM_q0.01.csv"
    
    # Output directory
    output_dir = "/home/geneticsShare/results/comparisons_wp3_wp4/Robust_LFMM/q0.01_1CA"
    
    # Dictionary to store index values for each envfactor
    envfactor_indices = defaultdict(list)
    
    # Read the CSV file
    print("Reading LFMM CSV file...")
...
if __name__ == "__main__":
    extract_index_by_envfactor_lfmm()
