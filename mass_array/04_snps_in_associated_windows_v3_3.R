...
snps_bio1_lfmm = fread(
  "/home/geneticsShare/LFMM_ANALYSES/res/ACORN_Qpet_1CA_MinDP20_MaxMeanDP178_Miss0075_MAF005_HDplot/Full_analysis_K_1/environment_bio1/CandidatesOrdered_envbio1_K1_q0.01_filtered.csv"
)
...
snps_bio3_lfmm = fread(
  "/home/geneticsShare/LFMM_ANALYSES/res/ACORN_Qpet_1CA_MinDP20_MaxMeanDP178_Miss0075_MAF005_HDplot/Full_analysis_K_1/environment_bio3/CandidatesOrdered_envbio3_K1_q0.01_filtered.csv"
)
...
snps_bio10_lfmm = fread(
  "/home/geneticsShare/LFMM_ANALYSES/res/ACORN_Qpet_1CA_MinDP20_MaxMeanDP178_Miss0075_MAF005_HDplot/Full_analysis_K_1/environment_bio10/CandidatesOrdered_envbio10_K1_q0.01_filtered.csv"
)
...
snps_bio12_lfmm = fread(
  "/home/geneticsShare/LFMM_ANALYSES/res/ACORN_Qpet_1CA_MinDP20_MaxMeanDP178_Miss0075_MAF005_HDplot/Full_analysis_K_1/environment_bio12/CandidatesOrdered_envbio12_K1_q0.01_filtered.csv"
)
...
snps_bio15_lfmm = fread(
  "/home/geneticsShare/LFMM_ANALYSES/res/ACORN_Qpet_1CA_MinDP20_MaxMeanDP178_Miss0075_MAF005_HDplot/Full_analysis_K_1/environment_bio15/CandidatesOrdered_envbio15_K1_q0.01_filtered.csv"
)
...
snps_bio18_lfmm = fread(
  "/home/geneticsShare/LFMM_ANALYSES/res/ACORN_Qpet_1CA_MinDP20_MaxMeanDP178_Miss0075_MAF005_HDplot/Full_analysis_K_1/environment_bio18/CandidatesOrdered_envbio18_K1_q0.01_filtered.csv"
)
...
snps_bio1_lfmm_gr$bioclim <- "bio1"
snps_bio1_lfmm_gr$method <- "lfmm"

snps_bio1_baypass_gr$bioclim <- "bio1"
snps_bio1_baypass_gr$method <- "baypass"

snps_bio3_lfmm_gr$bioclim <- "bio3"
snps_bio3_lfmm_gr$method <- "lfmm"

snps_bio3_baypass_gr$bioclim <- "bio3"
snps_bio3_baypass_gr$method <- "baypass"

snps_bio10_lfmm_gr$bioclim <- "bio10"
snps_bio10_lfmm_gr$method <- "lfmm"

snps_bio10_baypass_gr$bioclim <- "bio10"
snps_bio10_baypass_gr$method <- "baypass"

snps_bio12_lfmm_gr$bioclim <- "bio12"
snps_bio12_lfmm_gr$method <- "lfmm"

snps_bio12_baypass_gr$bioclim <- "bio12"
snps_bio12_baypass_gr$method <- "baypass"

snps_bio15_lfmm_gr$bioclim <- "bio15"
snps_bio15_lfmm_gr$method <- "lfmm"

snps_bio15_baypass_gr$bioclim <- "bio15"
snps_bio15_baypass_gr$method <- "baypass"

snps_bio18_lfmm_gr$bioclim <- "bio18"
snps_bio18_lfmm_gr$method <- "lfmm"

snps_bio18_baypass_gr$bioclim <- "bio18"
snps_bio18_baypass_gr$method <- "baypass"
...
merged_gr <- merge_ranges(c(
  snps_bio1_lfmm_gr,
  snps_bio1_baypass_gr,
  snps_bio3_lfmm_gr,
  snps_bio3_baypass_gr,
  snps_bio10_lfmm_gr,
  snps_bio10_baypass_gr,
  snps_bio12_lfmm_gr,
  snps_bio12_baypass_gr,
  snps_bio15_lfmm_gr,
  snps_bio15_baypass_gr,
  snps_bio18_lfmm_gr,
  snps_bio18_baypass_gr
))
...
thin_hiMAF_snps_bio1 <- merge_ranges(
  c(snps_bio1_lfmm_gr, snps_bio1_baypass_gr)
) |>
  join_overlap_intersect(maf_gr) |>
  filter(MAF >= 0.25) |>
...
thin_hiMAF_snps_bio3 <- merge_ranges(
  c(snps_bio3_lfmm_gr, snps_bio3_baypass_gr)
) |>
  join_overlap_intersect(maf_gr) |>
  thin_snps_by_maxMAF(min_dist = 5000) |>
  filter(MAF >= 0.25)
...
thin_hiMAF_snps_bio10 <- merge_ranges(
  c(snps_bio10_lfmm_gr, snps_bio10_baypass_gr)
) |>
  join_overlap_intersect(maf_gr) |>
  thin_snps_by_maxMAF(min_dist = 5000) |>
  filter(MAF >= 0.25)
...
thin_hiMAF_snps_bio12 <- merge_ranges(
  c(snps_bio12_lfmm_gr, snps_bio12_baypass_gr)
) |>
  join_overlap_intersect(maf_gr) |>
  thin_snps_by_maxMAF(min_dist = 5000) |>
  filter(MAF >= 0.25)
...
thin_hiMAF_snps_bio15 <- merge_ranges(
  c(snps_bio15_lfmm_gr, snps_bio15_baypass_gr)
) |>
  join_overlap_intersect(maf_gr) |>
  thin_snps_by_maxMAF(min_dist = 5000) |>
  filter(MAF >= 0.25)
...
thin_hiMAF_snps_bio18 <- merge_ranges(
  c(snps_bio18_lfmm_gr, snps_bio18_baypass_gr)
) |>
  join_overlap_intersect(maf_gr) |>
  thin_snps_by_maxMAF(min_dist = 5000) |>
  filter(MAF >= 0.25)
...
thin_balanced_snps <- combined_balanced |>
  ...
  slice_head(n = 23) |> # take up to 30 from each group
  ungroup() |>
  as_granges()
...
as_tibble(thin_balanced_snps) |>
  ...
  fwrite(
    "2025-11-06_massarray_proposed_snps_bio1-3-10-12-15-18_q001-bf10_balanced-26per-variable.tsv",
    sep = "\t"
  )
